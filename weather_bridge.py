...
def on_receive(packet, interface):
    try:
        ...
        upload_to_wu(weather, APP_STATE["wu_station_id"], APP_STATE["wu_password"])
        render_dashboard()
...
def main():
    ...
    APP_STATE["wu_station_id"] = wu_station_id
    APP_STATE["wu_password"] = wu_password
